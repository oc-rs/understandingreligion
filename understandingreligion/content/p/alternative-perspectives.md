...
Abstract: Alternative perspectives, due to their absence in mainstream texts and dismissal by historical scholars, are sometimes difficult to hear over the sound of traditional narratives – but this is increasingly changing for the better.
...
Whereas Bakhtier, with some [strong justification](http://www.sublimequran.org/about.html) renders the key word *wadriboohunna* as 'to go away' rather than 'to beat'. Her version in full reads:
...
You can read more about the case [here](https://www.theguardian.com/world/2018/nov/20/easter-island-british-museum-return-moai-statue), and you can learn more about the moai statues from the [Easter Island Statue Project](http://www.eisp.org/).
